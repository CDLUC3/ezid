...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            (
                impl.resolver.IdentifierStruct(
                    original="ark:/99999/fk412345/foo",
                    scheme="ark",
                    prefix="99999",
                    suffix="fk412345/foo",
                )
        ...
        (
            ...
            (
                impl.resolver.IdentifierStruct(
                    original="ark:/99999/fk412345/foo%efg%1abar",
                    scheme="ark",
                    prefix="99999",
                    suffix="fk412345/foo%EFg%1Abar",
                )
            ),
        ),
        (
            ...
            (
                impl.resolver.IdentifierStruct(
                    original="ark:/99999/fk-4-1-2-3-4-5/f-o-o",
                    scheme="ark",
                    prefix="99999",
                    suffix="fk412345/foo",
                )
        ...
        (
            ...
            (
                impl.resolver.IdentifierStruct(
                    original="ark:/99999/fk412345.//foo?info",
                    scheme="ark",
                    prefix="99999",
                    suffix="fk412345.foo",
                    inflection=True,
        ...
        (
            ...
            (
                impl.resolver.IdentifierStruct(
                    original="ark:/99999/", scheme="ark", prefix="99999", suffix=None
                )
            ),
        ),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "ark:/88122/zqfw0190_extra",
            ("ark:/88122/zqfw0190", "https://www.industrydocuments.ucsf.edu/docs/zqfw0190"),
        ),
        (
            "ark:88122/zq-fw-01-90_extra",
            ("ark:/88122/zqfw0190", "https://www.industrydocuments.ucsf.edu/docs/zqfw0190"),
        ),
