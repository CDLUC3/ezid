...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            (impl.resolver.IdentifierStruct(scheme="ark", prefix="99999", suffix="fk412345/foo")),
        ),
        (
            "ark:/99999/fk412345/foo%efg%1abar",
            (
                impl.resolver.IdentifierStruct(
                    scheme="ark", prefix="99999", suffix="fk412345/foo%EFg%1Abar"
                )
            ),
        ),
        (
        ...
        (
            "ark:/99999/fk412345.//foo?",
            (impl.resolver.IdentifierStruct(scheme="ark", prefix="99999", suffix="fk412345.foo", inflection=True)),
        ),
        (
            "ark:/99999/fk412345.//foo??",
            (impl.resolver.IdentifierStruct(scheme="ark", prefix="99999", suffix="fk412345.foo", inflection=True)),
        ...
        (
            "ark:/99999/",
            (impl.resolver.IdentifierStruct(scheme="ark", prefix="99999", suffix=None)),
        ),
        (
            "ark:/99999",
            (impl.resolver.IdentifierStruct(scheme="ark", prefix="99999", suffix=None)),
        ...
        (
            "ark:",
            (impl.resolver.IdentifierStruct(scheme="ark", prefix="")),
        ),
        (
            "ark:/",
            (impl.resolver.IdentifierStruct(scheme="ark", prefix="")),
        ...
        (
            ...
            (impl.resolver.IdentifierStruct(scheme="doi", prefix="10.5065", suffix="D6HM56KS")),
        ),
    ],
)
