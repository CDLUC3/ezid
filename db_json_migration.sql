...
(
	...
	constraint ezidapp_binderqueue_refIdentifier_id_50f30ec2_fk_ezidapp_r
		foreign key (refIdentifier_id) references ezidapp_refidentifier (id)
);

create index ezidapp_binderqueue_status_55adbf21
	on ezidapp_binderqueue (status);
...
select * from ezidapp_datacenter;

show table status;


alter table ezidapp_searchidentifier add primary key (`id`);
alter table ezidapp_searchidentifier add unique key  `identifier` (`identifier`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_5e7b1936` (`owner_id`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_365b2611` (`ownergroup_id`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_13bc2970` (`datacenter_id`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_83a0eb3f` (`profile_id`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_owner_id_60c2c5fffcb40895_idx` (`owner_id`, `identifier`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_ownergroup_id_4b76dd7c4564df4f_idx` (`ownergroup_id`, `identifier`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_owner_id_47ecdfd54025f1f1_idx` (`owner_id`, `createTime`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_owner_id_59016f4a7ffbcaaa_idx` (`owner_id`, `updateTime`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_owner_id_5b203a171bdbab38_idx` (`owner_id`, `status`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_owner_id_3e88a7c1b2b5c693_idx` (`owner_id`, `exported`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_owner_id_58dfc6401ef0e359_idx` (`owner_id`, `crossrefStatus`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_owner_id_431b22d7016b97df_idx` (`owner_id`, `profile_id`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_owner_id_52f3896c5fc67016_idx` (`owner_id`, `isTest`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_owner_id_5c11adaf88d856d0_idx` (`owner_id`, `searchablePublicationYear`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_owner_id_54da573427e72c0e_idx` (`owner_id`, `searchableResourceType`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_owner_id_18a46334256a7530_idx` (`owner_id`, `hasMetadata`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_owner_id_1d05153b51fd9dff_idx` (`owner_id`, `hasIssues`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_owner_id_76e131b0c70070a1_idx` (`owner_id`, `resourceCreatorPrefix`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_owner_id_198f8d3796dae4b9_idx` (`owner_id`, `resourceTitlePrefix`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_owner_id_263dc1dd7d2fd3ef_idx` (`owner_id`, `resourcePublisherPrefix`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_ownergroup_id_39b7cdc64bc267c3_idx` (`ownergroup_id`, `createTime`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_ownergroup_id_6c5194bcf1d0014e_idx` (`ownergroup_id`, `updateTime`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_ownergroup_id_1d431d7513ab02ec_idx` (`ownergroup_id`, `status`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_ownergroup_id_48b886662536e7fd_idx` (`ownergroup_id`, `exported`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_ownergroup_id_2114f948ed092669_idx` (`ownergroup_id`, `crossrefStatus`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_ownergroup_id_6cfbff68ca3e25cb_idx` (`ownergroup_id`, `profile_id`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_ownergroup_id_449f25bec77c57da_idx` (`ownergroup_id`, `isTest`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_ownergroup_id_4a1baf4823ddab6c_idx` (`ownergroup_id`, `searchablePublicationYear`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_ownergroup_id_54e4e22002a54d2_idx` (`ownergroup_id`, `searchableResourceType`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_ownergroup_id_65871830cd29aaf0_idx` (`ownergroup_id`, `hasMetadata`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_ownergroup_id_4ad29fb0ede49103_idx` (`ownergroup_id`, `hasIssues`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_ownergroup_id_3ac1ed25c2bfbb2d_idx` (`ownergroup_id`, `resourceCreatorPrefix`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_ownergroup_id_68875bac9225d3c9_idx` (`ownergroup_id`, `resourceTitlePrefix`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_ownergroup_id_2388bfe261a735c5_idx` (`ownergroup_id`, `resourcePublisherPrefix`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifie_publicSearchVisible_58de9f6f00b8058e_idx` (`publicSearchVisible`, `identifier`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifie_publicSearchVisible_1932465b0335635c_idx` (`publicSearchVisible`, `createTime`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifie_publicSearchVisible_47b0a294295f5ef5_idx` (`publicSearchVisible`, `updateTime`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifie_publicSearchVisible_1e447c57e83c8d5d_idx` (`publicSearchVisible`, `searchablePublicationYear`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifie_publicSearchVisible_47396846c619370f_idx` (`publicSearchVisible`, `searchableResourceType`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifie_publicSearchVisible_117042133b78a88e_idx` (`publicSearchVisible`, `resourceCreatorPrefix`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_publicSearchVisible_6807647c6d8cb52_idx` (`publicSearchVisible`, `resourceTitlePrefix`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifie_publicSearchVisible_2e067bd0a9494a38_idx` (`publicSearchVisible`, `resourcePublisherPrefix`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_searchableTarget_24d34538786996df_idx` (`searchableTarget`);
alter table ezidapp_searchidentifier add key  `ezidapp_searchidentifier_oaiVisible_1d291a23fcff2ce2_idx` (`oaiVisible`, `updateTime`);
...
alter table ezidapp_searchidentifier add constraint `ez_datacenter_id_2c99a133444936c8_fk_ezidapp_searchdatacenter_id`;
...
select (select count(*) from ezidapp_searchdatacenter) as searchdatacenter,
       ...
       (select count(*) from ezidapp_storerealm) as storerealm, (select count(*) from ezidapp_searchuser) as searchuser,
...
alter table `ezidapp_searchidentifier` add column metadata json default null;
alter table `ezidapp_storeidentifier` add column metadata json default null;
...
create table `ezidapp_searchidentifier`
    (
        ...
        constraint `ez_datacenter_id_2c99a133444936c8_fk_ezidapp_searchdatacenter_id`
            foreign key (`datacenter_id`) references `ezidapp_searchdatacenter` (`id`),
        constraint `ezidapp__profile_id_112e6b8634f63b63_fk_ezidapp_searchprofile_id`
            foreign key (`profile_id`) references `ezidapp_searchprofile` (`id`),
        constraint `ezidapp_ownergroup_id_69f5065adf48f369_fk_ezidapp_searchgroup_id`
            foreign key (`ownergroup_id`) references `ezidapp_searchgroup` (`id`),
        constraint `ezidapp_searc_owner_id_17d8ce4cfb6b0401_fk_ezidapp_searchuser_id`
            foreign key (`owner_id`) references `ezidapp_searchuser` (`id`)
    )
engine = InnoDB
...
alter table ezidapp_searchidentifier add column metadata json;
...
create index ezidapp_binderqueue_identifier_9b9a81d1
	on ezidapp_binderqueue (identifier);

create index ezidapp_binderqueue_owner_7a7cf1d5
	on ezidapp_binderqueue (owner);
...
create index ezidapp_crossrefqueue_identifier_9b5a567d
	on ezidapp_crossrefqueue (identifier);

create index ezidapp_crossrefqueue_owner_5b61bd96
	on ezidapp_crossrefqueue (owner);

create index ezidapp_crossrefqueue_status_285b2361
	on ezidapp_crossrefqueue (status);
...
create index ezidapp_datacitequeue_identifier_a6494081
	on ezidapp_datacitequeue (identifier);

create index ezidapp_datacitequeue_owner_c31423b7
	on ezidapp_datacitequeue (owner);

create index ezidapp_datacitequeue_status_c99416f7
	on ezidapp_datacitequeue (status);
...
create index ezidapp_store_realm_id_3405b66a3ee93b42_fk_ezidapp_storerealm_id
	on ezidapp_group (realm_id);
...
(
	...
	constraint storegroup_id
		unique (group_id, shoulder_id)
);

create index ezidapp_stor_shoulder_id_592128c84020a89a_fk_ezidapp_shoulder_id
	on ezidapp_group_shoulders (shoulder_id);
...
create index ezidapp_storeidentifier_13bc2970
	on ezidapp_identifier (datacenter_id);

create index ezidapp_storeidentifier_365b2611
	on ezidapp_identifier (ownergroup_id);

create index ezidapp_storeidentifier_5e7b1936
	on ezidapp_identifier (owner_id);

create index ezidapp_storeidentifier_83a0eb3f
	on ezidapp_identifier (profile_id);
...
create index ezidapp_linkchecker_28a3c780
	on ezidapp_linkchecker (numFailures);

create index ezidapp_linkchecker_5e7b1936
	on ezidapp_linkchecker (owner_id);

create index ezidapp_linkchecker_owner_id_a6cbca8ea9539b4_idx
	on ezidapp_linkchecker (owner_id, isBad, lastCheckTime);
...
create table ezid.ezidapp_refidentifier
    (
        ...
        ownergroup_id int null,
        profile_id int null,
	constraint ezidapp_refidentifie_datacenter_id_0927c7e5_fk_ezidapp_d
		foreign key (datacenter_id) references ezid.ezidapp_datacenter (id),
	constraint ezidapp_refidentifier_owner_id_bcf67913_fk_ezidapp_user_id
		foreign key (owner_id) references ezid.ezidapp_user (id),
	constraint ezidapp_refidentifier_ownergroup_id_d390fbc9_fk_ezidapp_group_id
		foreign key (ownergroup_id) references ezid.ezidapp_group (id),
	constraint ezidapp_refidentifier_profile_id_f497af12_fk_ezidapp_profile_id
		foreign key (profile_id) references ezid.ezidapp_profile (id)
);
...
create index ezidapp_searchidentifie_publicSearchVisible_47b0a294295f5ef5_idx
	on ezidapp_searchidentifier (publicSearchVisible, updateTime);

create index ezidapp_searchidentifier_13bc2970
	on ezidapp_searchidentifier (datacenter_id);

create index ezidapp_searchidentifier_5e7b1936
	on ezidapp_searchidentifier (owner_id);

create index ezidapp_searchidentifier_83a0eb3f
	on ezidapp_searchidentifier (profile_id);

create index ezidapp_searchidentifier_owner_id_5c11adaf88d856d0_idx
	on ezidapp_searchidentifier (owner_id, searchablePublicationYear);

create index ezidapp_searchidentifier_ownergroup_id_2388bfe261a735c5_idx
	on ezidapp_searchidentifier (ownergroup_id, resourcePublisherPrefix);
...
create index ezid_datacenter_id_4fb7570a75b0c69_fk_ezidapp_storedatacenter_id
	on ezidapp_shoulder (datacenter_id);

create index ezidapp_shoulder_registration_agency__ba15f13e_fk_ezidapp_r
	on ezidapp_shoulder (registration_agency_id);

create index ezidapp_shoulder_shoulder_type_id_184bbced_fk_ezidapp_s
	on ezidapp_shoulder (shoulder_type_id);
...
(
	...
	hasMetadata tinyint(1) not null,
	count int not null,
	constraint ezidapp_statistics_month_23cad98a47c1a6fc_uniq
		unique (month, owner, type, hasMetadata)
);

create index ezidapp_statistics_7436f942
	on ezidapp_statistics (month);
...
create index ezidapp_store_group_id_7eff2039d02834ed_fk_ezidapp_storegroup_id
	on ezidapp_user (group_id);

create index ezidapp_store_realm_id_5d5c037d7f3fac93_fk_ezidapp_storerealm_id
	on ezidapp_user (realm_id);
...
(
	...
	to_user_id int null,
	constraint from_storeuser_id
		unique (from_user_id, to_user_id)
);

create index ezidapp_storeuser_pr_to_storeuser_id_5588e255_fk_ezidapp_s
	on ezidapp_user_proxies (to_user_id);
...
(
	...
	user_id int null,
	shoulder_id int not null,
	constraint storeuser_id
		unique (user_id, shoulder_id)
);

create index ezidapp_stor_shoulder_id_760fcf030c9067e7_fk_ezidapp_shoulder_id
	on ezidapp_user_shoulders (shoulder_id);
...
create index ezidapp_searchidentifie_publicSearchVisible_117042133b78a88e_idx
	on tmp_si (publicSearchVisible, resourceCreatorPrefix);

create index ezidapp_searchidentifie_publicSearchVisible_1932465b0335635c_idx
	on tmp_si (publicSearchVisible, createTime);

create index ezidapp_searchidentifie_publicSearchVisible_1e447c57e83c8d5d_idx
	on tmp_si (publicSearchVisible, searchablePublicationYear);

create index ezidapp_searchidentifie_publicSearchVisible_2e067bd0a9494a38_idx
	on tmp_si (publicSearchVisible, resourcePublisherPrefix);

create index ezidapp_searchidentifie_publicSearchVisible_47396846c619370f_idx
	on tmp_si (publicSearchVisible, searchableResourceType);

create index ezidapp_searchidentifie_publicSearchVisible_47b0a294295f5ef5_idx
	on tmp_si (publicSearchVisible, updateTime);

create index ezidapp_searchidentifie_publicSearchVisible_58de9f6f00b8058e_idx
	on tmp_si (publicSearchVisible, identifier);

create index ezidapp_searchidentifier_13bc2970
	on tmp_si (datacenter_id);

create index ezidapp_searchidentifier_365b2611
	on tmp_si (ownergroup_id);

create index ezidapp_searchidentifier_5e7b1936
	on tmp_si (owner_id);

create index ezidapp_searchidentifier_83a0eb3f
	on tmp_si (profile_id);

create fulltext index ezidapp_searchidentifier_keywords
	on tmp_si (keywords);

create index ezidapp_searchidentifier_oaiVisible_1d291a23fcff2ce2_idx
	on tmp_si (oaiVisible, updateTime);

create index ezidapp_searchidentifier_owner_id_18a46334256a7530_idx
	on tmp_si (owner_id, hasMetadata);

create index ezidapp_searchidentifier_owner_id_198f8d3796dae4b9_idx
	on tmp_si (owner_id, resourceTitlePrefix);

create index ezidapp_searchidentifier_owner_id_1d05153b51fd9dff_idx
	on tmp_si (owner_id, hasIssues);

create index ezidapp_searchidentifier_owner_id_263dc1dd7d2fd3ef_idx
	on tmp_si (owner_id, resourcePublisherPrefix);

create index ezidapp_searchidentifier_owner_id_3e88a7c1b2b5c693_idx
	on tmp_si (owner_id, exported);

create index ezidapp_searchidentifier_owner_id_431b22d7016b97df_idx
	on tmp_si (owner_id, profile_id);

create index ezidapp_searchidentifier_owner_id_47ecdfd54025f1f1_idx
	on tmp_si (owner_id, createTime);

create index ezidapp_searchidentifier_owner_id_52f3896c5fc67016_idx
	on tmp_si (owner_id, isTest);

create index ezidapp_searchidentifier_owner_id_54da573427e72c0e_idx
	on tmp_si (owner_id, searchableResourceType);

create index ezidapp_searchidentifier_owner_id_58dfc6401ef0e359_idx
	on tmp_si (owner_id, crossrefStatus);

create index ezidapp_searchidentifier_owner_id_59016f4a7ffbcaaa_idx
	on tmp_si (owner_id, updateTime);

create index ezidapp_searchidentifier_owner_id_5b203a171bdbab38_idx
	on tmp_si (owner_id, status);

create index ezidapp_searchidentifier_owner_id_5c11adaf88d856d0_idx
	on tmp_si (owner_id, searchablePublicationYear);

create index ezidapp_searchidentifier_owner_id_60c2c5fffcb40895_idx
	on tmp_si (owner_id, identifier);

create index ezidapp_searchidentifier_owner_id_76e131b0c70070a1_idx
	on tmp_si (owner_id, resourceCreatorPrefix);

create index ezidapp_searchidentifier_ownergroup_id_1d431d7513ab02ec_idx
	on tmp_si (ownergroup_id, status);

create index ezidapp_searchidentifier_ownergroup_id_2114f948ed092669_idx
	on tmp_si (ownergroup_id, crossrefStatus);

create index ezidapp_searchidentifier_ownergroup_id_2388bfe261a735c5_idx
	on tmp_si (ownergroup_id, resourcePublisherPrefix);

create index ezidapp_searchidentifier_ownergroup_id_39b7cdc64bc267c3_idx
	on tmp_si (ownergroup_id, createTime);

create index ezidapp_searchidentifier_ownergroup_id_3ac1ed25c2bfbb2d_idx
	on tmp_si (ownergroup_id, resourceCreatorPrefix);

create index ezidapp_searchidentifier_ownergroup_id_449f25bec77c57da_idx
	on tmp_si (ownergroup_id, isTest);

create index ezidapp_searchidentifier_ownergroup_id_48b886662536e7fd_idx
	on tmp_si (ownergroup_id, exported);

create index ezidapp_searchidentifier_ownergroup_id_4a1baf4823ddab6c_idx
	on tmp_si (ownergroup_id, searchablePublicationYear);

create index ezidapp_searchidentifier_ownergroup_id_4ad29fb0ede49103_idx
	on tmp_si (ownergroup_id, hasIssues);

create index ezidapp_searchidentifier_ownergroup_id_4b76dd7c4564df4f_idx
	on tmp_si (ownergroup_id, identifier);

create index ezidapp_searchidentifier_ownergroup_id_54e4e22002a54d2_idx
	on tmp_si (ownergroup_id, searchableResourceType);

create index ezidapp_searchidentifier_ownergroup_id_65871830cd29aaf0_idx
	on tmp_si (ownergroup_id, hasMetadata);

create index ezidapp_searchidentifier_ownergroup_id_68875bac9225d3c9_idx
	on tmp_si (ownergroup_id, resourceTitlePrefix);

create index ezidapp_searchidentifier_ownergroup_id_6c5194bcf1d0014e_idx
	on tmp_si (ownergroup_id, updateTime);

create index ezidapp_searchidentifier_ownergroup_id_6cfbff68ca3e25cb_idx
	on tmp_si (ownergroup_id, profile_id);

create index ezidapp_searchidentifier_publicSearchVisible_6807647c6d8cb52_idx
	on tmp_si (publicSearchVisible, resourceTitlePrefix);

create fulltext index ezidapp_searchidentifier_resourceCreator
	on tmp_si (resourceCreator);

create fulltext index ezidapp_searchidentifier_resourcePublisher
	on tmp_si (resourcePublisher);

create fulltext index ezidapp_searchidentifier_resourceTitle
	on tmp_si (resourceTitle);

create index ezidapp_searchidentifier_searchableTarget_24d34538786996df_idx
	on tmp_si (searchableTarget);
...
create index ezidapp_storeidentifier_13bc2970
	on tmp_stid (datacenter_id);

create index ezidapp_storeidentifier_365b2611
	on tmp_stid (ownergroup_id);

create index ezidapp_storeidentifier_5e7b1936
	on tmp_stid (owner_id);

create index ezidapp_storeidentifier_83a0eb3f
	on tmp_stid (profile_id);
...
create index ezidapp_storeidentifier_13bc2970
	on tmp_stid2 (datacenter_id);

create index ezidapp_storeidentifier_365b2611
	on tmp_stid2 (ownergroup_id);

create index ezidapp_storeidentifier_5e7b1936
	on tmp_stid2 (owner_id);

create index ezidapp_storeidentifier_83a0eb3f
	on tmp_stid2 (profile_id);
