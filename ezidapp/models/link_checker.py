...
class LinkChecker (django.db.models.Model):
  ...
  target = django.db.models.URLField(max_length=\
    _identifierModule.Identifier._meta.get_field("target").max_length)
  # The identifier's target URL, e.g., "http://foo.com/bar".

  lastCheckTime = django.db.models.IntegerField(default=0,
  ...
  size = django.db.models.IntegerField(blank=True, null=True,
    validators=[django.core.validators.MinValueValidator(0)])
