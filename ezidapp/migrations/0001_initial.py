# Generated by Django 3.2.8 on 2022-05-25 10:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('U', 'Awaiting submission'), ('C', 'Submitted, unchecked'), ('S', 'Submitted'), ('W', 'Registered with warning'), ('F', 'Registration failed'), ('I', 'Ignored (operation not applicable)'), ('O', 'Completed successfully')], db_index=True, default='U', max_length=1)),
        ...
        migrations.AddField(
            ...
            name='owner',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.PROTECT, to='ezidapp.user'),
        ),
        migrations.AddField(
            model_name='refidentifier',
            name='ownergroup',
        ...
        migrations.CreateModel(
            ...
            options={
                'index_together': {('owner_id', 'searchablePublicationYear'), ('owner_id', 'updateTime'), ('owner_id', 'profile_id'), ('owner_id', 'crossrefStatus'), ('ownergroup_id', 'exported'), ('owner_id', 'resourceCreatorPrefix'), ('publicSearchVisible', 'searchableResourceType'), ('owner_id', 'hasIssues'), ('ownergroup_id', 'identifier'), ('ownergroup_id', 'resourceTitlePrefix'), ('owner_id', 'searchableResourceType'), ('owner_id', 'hasMetadata'), ('ownergroup_id', 'createTime'), ('publicSearchVisible', 'identifier'), ('publicSearchVisible', 'createTime'), ('owner_id', 'exported'), ('owner_id', 'status'), ('oaiVisible', 'updateTime'), ('ownergroup_id', 'searchablePublicationYear'), ('ownergroup_id', 'updateTime'), ('publicSearchVisible', 'searchablePublicationYear'), ('ownergroup_id', 'profile_id'), ('ownergroup_id', 'crossrefStatus'), ('owner_id', 'identifier'), ('owner_id', 'resourceTitlePrefix'), ('ownergroup_id', 'hasIssues'), ('ownergroup_id', 'isTest'), ('owner_id', 'createTime')},
            },
        ),
    ]
