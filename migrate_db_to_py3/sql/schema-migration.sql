...
alter table ezidapp_searchidentifier
add constraint `ezidapp_searc_owner_id_17d8ce4cfb6b0401_fk_ezidapp_searchuser_id`
foreign key (`owner_id`) references `ezidapp_storeuser` (`id`)
;
alter table ezidapp_searchidentifier
add constraint `ezidapp_ownergroup_id_69f5065adf48f369_fk_ezidapp_searchgroup_id`
foreign key (`ownergroup_id`) references `ezidapp_storegroup` (`id`)
;
alter table ezidapp_searchidentifier
add constraint `ezidapp__profile_id_112e6b8634f63b63_fk_ezidapp_searchprofile_id`
...
foreign key (`datacenter_id`) references `ezidapp_storedatacenter` (`id`)
;
