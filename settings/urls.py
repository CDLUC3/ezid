...
urlpatterns = django.conf.urls.defaults.patterns("",
  ...
  _p("id/(\S+)$", "ui_manage.details"),
  _p("manage/edit/(\S+)$", "ui_manage.edit"),
  # doesn't work _p("manage/edit/((ark:|doi:|hdl:|urn:)[0-9a-z\/\.]+)$", "ui_manage.edit"),
  ...
  _p("admin/add_user$", "ui_admin.add_user"),
  _p("admin/manage_groups$", "ui_admin.manage_groups"),
  _p("admin/add_group$", "ui_admin.add_group"),
