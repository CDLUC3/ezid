...
urlpatterns = django.conf.urls.defaults.patterns("",
  ...
  _p("admin/csv_usage$", "ui_admin.csv_usage", { "ssl": True }),
  ...
  _p("account/change_pwd$", "ui_account.change_pwd", { "ssl": True }),
  _p("account/user_stats$", "ui_account.user_stats", { "ssl": True }),
