...
urlpatterns = [
    ...
    # API
    django.urls.re_path("^ark:(?P<identifier>.*)$",        impl.api.resolveArkIdentifier,      name="api.resolveArkIdentifier"),
    django.urls.re_path("^doi:(?P<identifier>.*)$",        impl.api.resolveDoiIdentifier,      name="api.resolveDoiIdentifier"),
