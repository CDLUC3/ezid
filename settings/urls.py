...
urlpatterns = django.conf.urls.patterns("",
  ...
  ("^admin-old/system_status$", "ui_admin.system_status", { "ssl": True }),
  ("^admin-old/ajax_system_status$", "ui_admin.ajax_system_status"),
  ("^admin-old/alert_message$", "ui_admin.alert_message", { "ssl": True }),
  ("^admin-old/new_account$", "ui_admin.new_account", { "ssl": True }),
