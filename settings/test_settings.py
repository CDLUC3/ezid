...
DAEMONS_BACKGROUND_PROCESSING_IDLE_SLEEP = 1
DAEMONS_STATUS_LOGGING_INTERVAL = 1  ################# 60
DAEMONS_BINDER_PROCESSING_IDLE_SLEEP = 1
DAEMONS_BINDER_PROCESSING_ERROR_SLEEP = 300
DAEMONS_BINDER_NUM_WORKER_THREADS = 3
DAEMONS_DATACITE_PROCESSING_IDLE_SLEEP = 1
...
# Max number of tasks to retrieve from the queue at a time
MAX_BATCH_SIZE = 100
