...
class CreatorForm(forms.Form):
  ...
  def __init__(self, *args, **kwargs):
    ...
    # Min 2-n # of NameIdentifier fields are generated by NameIdMultBaseFormSet class 
...
class GeoLocForm(forms.Form):
  ...
  def clean_geoLocationPolygon(self):
    ...
    r = geometry_util.polygonToDatacite(text)
    if isinstance(r, basestring):
      raise ValidationError(r)
    # Warning message broadcast deferred - Ignoring things like altitudes and inner polygons (holes).
    # if len(r[1]) > 0:
    #   pass
    return r
